const FactSheetData = (() => {
  const factSheets = [
    {
      ...
      evidenceBase: "KNHANES 2016-2022 and NHIS 2002-2022 analysis",
      officialSourceUrl: "https://www.lipid.or.kr/",
  ...
  const factSheetMetrics = [
    ...
    metric("treated-control", "Control among treated", "87.4%", "치료자 중 조절률.", "치료 지속성과 치료 강도 조정 메시지를 분리한다."),
